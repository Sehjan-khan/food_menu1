...
class MealsScreen extends StatefulWidget {
  ...
  const MealsScreen({super.key, required this.categoryName, required this.favorites, required this.filters,});
...
class _MealsScreenState extends State<MealsScreen> {
  ...
  Widget build(BuildContext context) {
    final categoryMeals = widget.filteredMeals.where((meal) => meal.category == widget.categoryName).toList();
    ...
    return Scaffold(
      ...
      body: categoryMeals.isEmpty ?  Center(
        child: Text(
          'No Meals Here!',
          style: TextStyle(
